...
Upon publication of the Ahlfeldt, Heblich, Seidel, Yin (2026) paper, we will make the algorithm and a synthetic trial data set available. 

When using the toolkit in your work, please  **cite Ahlfeldt, Heblich, Seidel, Yin (2026): The price of productivity. Berlin School of Economics Discussion Paper 91**. Please notice that this paper is pre-publication and such the methodology and the index may evolve.
